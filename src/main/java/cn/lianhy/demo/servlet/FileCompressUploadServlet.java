...
@Slf4j
@WebServlet(urlPatterns = "/UPLOADCOMPRESS")
public class FileCompressUploadServlet extends HttpServlet {
        ...
        try {
            ...
            while (iterator.hasNext()){
                ...
                if(!item.isFormField()){
                    ...
                    Thumbnails.of(item.getInputStream()).scale(1f).outputQuality(0.5f).toFile(cdnPath+ranName);
                    item.delete();
